...
class CoursesGridScreen extends StatelessWidget {
  ...
  final List<Course> _allCourses = const [
    Course(
      ...
      imagePath: 'assets/acc201.png',
    ),
    Course(
      code: 'CS 303',
      name: 'Logic and Digital System Design',
      instructor: 'Instructor',
      imagePath: 'assets/cs303.png',
    ),
    Course(
      code: 'HUM 201',
    ...
    Course(
      ...
      instructor: 'Instructor',
      imagePath: 'assets/psy201.png',
    ),
    Course(
      code: 'CS 204',
      name: 'Advanced Programming',
      instructor: 'Instructor',
      imagePath: 'assets/cs204.png',
    ),
    Course(
      code: 'MATH 306',
    ...
    Course(
      ...
      instructor: 'Instructor',
      imagePath: 'assets/tll102.png',
    ),
    Course(
      code: 'NS 102',
      name: 'Science of Nature II',
      instructor: 'Instructor',
      imagePath: 'assets/ns102.png',
    ),
    Course(
      code: 'SPS 102',
      name: 'Humanity and Society II',
      instructor: 'Instructor',
      imagePath: 'assets/sps102.png',
    ),
  ];
