...
class CoursesScreen extends StatelessWidget {
  ...
  final List<Course> _allCourses = const [
    Course(code: 'HUM 201', name: 'Major Works of Literature', instructor: 'Zeynep Nevin Yelçe', imagePath: 'assets/hum201.png', term: 'FALL 2025 - 2026'),
    Course(code: 'CS 303', name: 'Logic and Digital System Design', instructor: 'Özcan Öztürk', imagePath: 'assets/cs303_2.png', term: 'FALL 2025 - 2026'),
    Course(code: 'PSY 201', name: 'Mind and Behavior', instructor: 'Çiğdem Bağcı', imagePath: 'assets/psy201.png', term: 'FALL 2025 - 2026'),
    Course(code: 'CS 204', name: 'Advanced Programming', instructor: 'Kamer Kaya', imagePath: 'assets/cs204_2.png', term: 'FALL 2025 - 2026'),
    Course(code: 'NS 102', name: 'Science of Nature II', instructor: 'Çiğdem Altıntaş', imagePath: 'assets/ns102.png', term: 'SUMMER 2025'),
    Course(code: 'SPS 102', name: 'Humanity and Society II', instructor: 'Melike Ayşe Kocacık Şenol', imagePath: 'assets/sps102.png', term: 'SUMMER 2025'),
  ];
